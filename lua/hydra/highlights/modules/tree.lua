...
M.load = function(opts)
  ...
  hl('NvimTreeFolderName', { fg = c.base0 }) -- (Directory)
  ...
  -- hl('NvimTreeFileIcon')
  hl('NvimTreeEmptyFolderName', { fg = c.base0 }) -- (Directory)
  ...
  hl('NvimTreeIndentMarker', { fg = c.base01 })
  ...
  hl('NvimTreeNormal', { fg = c.base0, bg = c.base04 })
  hl('NvimTreeNormalFloat', { link = 'NvimTreeNormal' })
  hl('NvimTreeEndOfBuffer', { fg = c.base04 }) -- (NonText)
  -- hl('NvimTreeCursorLine') -- (CursorLine)
  -- hl('NvimTreeCursorLineNr') -- (CursorLineNr)
  -- hl('NvimTreeLineNr') -- (LineNr)
  hl('NvimTreeWinSeparator', { fg = c.base04, bg = c.base04 }) -- (WinSeparator)
