...
M.load = function(opts)
  ...
  hl('ColorColumn', { bg = c.base04 }) -- used for columns
  ...
  hl('Directory', { fg = c.yellow, bold = true }) -- directory names
  ...
  hl('WinSeparator', { fg = c.yellow, bg = c.base03 }, { transparent = config.transparent }) -- Separators between window splits
  ...
  hl('CursorLineNr', { fg = c.base0, bg = c.base02, bold = true }, { transparent = config.transparent }) -- Like LineNr when 'cursorline' is set
  ...
  hl('PmenuThumb', { bg = c.blue }) -- Popup menu: Thumb of the scrollbar
  ...
  hl('Title', { fg = c.red, bold = true }) -- Titles for output from ":set all", ":autocmd" etc.
